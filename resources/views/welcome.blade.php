        ...
        <div class="lightSlider" data-item="6" data-item-xl="4" data-item-md="2" data-item-sm="1" data-pause="7000"
            ...
            <div>
                <div class="white text-center p-4">
                    ...
                    <div class="mt-3"><span class="badge badge-success r-30"><i class="icon-check mr-2"></i> Runing</span>
                    </div>
                </div>
            </div>
            <div>
                <div class="white text-center p-4">
                    ...
                    <div class="mt-3"><span class="badge badge-success r-30"><i class="icon-check mr-2"></i>Enabled</span>
                    </div>
                </div>
            </div>
            <div>
                <div class="white text-center p-4">
                    ...
                    <div class="mt-3"><span class="badge badge-danger r-30"><i class="icon-close mr-2"></i>Stopped</span>
                    </div>
                </div>
            </div>
            <div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="icon icon-circle s-12  mr-2 text-warning"></span>
                                                Inactive</td>
                                            <td><span class="r-3 badge badge-success ">Administrator</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="icon icon-circle s-12  mr-2 text-warning"></span>
                                                Inactive</td>
                                            <td><span class="r-3 badge badge-warning">Subscriber</span>
                                            </td>
                                            <td>
                                                <a href="panel-page-profile.html"><i class="icon-eye mr-3"></i></a>
                                                <a href="panel-page-profile.html"><i class="icon-pencil"></i></a>
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input checkSingle"
                                                        id="user_id_10" required><label class="custom-control-label"
                                                        for="user_id_10"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="avatar avatar-md mr-3 mt-1 float-left">
                ...
                <div class="col-md-3 b-l">
                    <div class="card no-b">
                        ...
                        <div class="p-5" style="height: 400px">
                            <canvas data-chart="chartJs" data-chart-type="pie"
                                data-dataset="[
                                                            [75, 50],
                                                            [25, 50],
                                                        ]"
